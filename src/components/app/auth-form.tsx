  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-emerald-50 via-background to-emerald-50/30 dark:from-emerald-950/20 dark:via-background dark:to-emerald-950/10 p-4">
      <div className="w-full max-w-md">
        ...
        <Card>
          <CardHeader>
            <CardTitle>{isRegister ? 'Создать аккаунт' : 'Вход в систему'}</CardTitle>
            <CardDescription>
              {isRegister
                ? 'Зарегистрируйтесь для начала работы с TeamFlow'
                : 'Войдите в свой аккаунт TeamFlow'}
            </CardDescription>
          </CardHeader>
          <CardContent>
            {/* Google Sign In */}
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="space-y-2">
                ...
                <p className="text-xs text-muted-foreground">Демо-режим: введите любой email для входа</p>
              </div>
